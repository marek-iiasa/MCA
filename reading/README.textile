h4. Recommended reading on the Multiple-Criteria Analysis (MCA)

This directory contains the PDF files focused on various topics relevant for the MCA. The focus is on the MCMA (Multiple-CriteriaModel Analysis) and MCAA (Multiple-Criteria Analysis of Alternatives) applications developed at IIASA.
Due to the copyright reasons, as well as the vast number of the MCA-related references,
only the publications (co-)authored by the repository owner are posted.
